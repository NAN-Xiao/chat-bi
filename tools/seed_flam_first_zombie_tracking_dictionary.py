...
FIELDS = [
    ...
    },
    {
        "table_name": "user",
        "field_name": "pay",
        "field_comment": "用户付费累计与付费次数 JSON；paytotal 为截至 dt 的累计付费快照，pay1/pay2/pay3/pay7 为注册窗口累计付费。",
        "field_role": "payment_json",
        "semantic_type": "json",
        "aliases": ["付费信息", "累计付费"],
        "example_values": ["paytotal", "pay1", "pay2", "pay3", "pay7", "firstpaytime", "lastpaytime"],
        "ai_notes": "新增首日付费金额取注册日快照行的 pay1；日付费金额用 paytotal 相邻快照差分；7 日 LTV 使用成熟 cohort 的 pay1/pay2/pay3/pay7 窗口值。",
    },
    {
        "table_name": "user",
    ...
    },
    {
        "table_name": "user",
        "field_name": "pay.pay1",
        "field_comment": "注册首日累计付费窗口字段；新增首日付费固定取注册日快照该字段。",
        "field_role": "json_path_metric",
        "semantic_type": "number",
        "aliases": ["首日付费", "当日LTV"],
        "expression": "JSON_UNQUOTE(JSON_EXTRACT(pay, '$.pay1'))",
        "example_values": ["0", "9.99"],
        "ai_notes": "不要从后续快照 MAX(pay1) 推导首日付费。",
    },
    {
        "table_name": "user",
        "field_name": "pay.pay2",
        "field_comment": "注册后第 1 日累计付费窗口字段；LTV 表中的第 1 日使用该字段。",
        "field_role": "json_path_metric",
        "semantic_type": "number",
        "aliases": ["第1日LTV", "D1累计付费"],
    ...
    },
    {
        "table_name": "user",
        "field_name": "pay.pay3",
        "field_comment": "注册后第 2 日累计付费窗口字段；LTV 表中的第 2 日使用该字段。",
        "field_role": "json_path_metric",
        "semantic_type": "number",
        "aliases": ["第2日LTV", "D2累计付费"],
    ...
    },
    {
        "table_name": "user",
        "field_name": "pay.pay7",
        "field_comment": "注册后第 7 日累计付费窗口字段；7 日 LTV 和渠道 7 日累计付费使用成熟 cohort 的该字段。",
        "field_role": "json_path_metric",
        "semantic_type": "number",
        "aliases": ["7日LTV", "D7累计付费"],
        "expression": "JSON_UNQUOTE(JSON_EXTRACT(pay, '$.pay7'))",
        "example_values": ["0", "49.99"],
        "ai_notes": "只展示 D7 已成熟 cohort，不要把未成熟 cohort 当 0。",
    },
    {
        "table_name": "user",
        "field_name": "remain",
