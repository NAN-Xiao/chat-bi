...
revision = "154platformhourlyzerofill"
down_revision = "153platformdailyzerofill"
branch_labels = None
depends_on = None


SKILL_MARKER = "<!-- platform-foundation-skill:sql-date-grouping:v1 -->"
DAILY_ZERO_FILL_SECTION_MARKER = "<!-- platform-foundation-skill:daily-zero-fill:v1 -->"
...
ZERO_FILL_SECTION = f"""{DAILY_ZERO_FILL_SECTION_MARKER}
...
def upgrade() -> None:
    result = op.get_bind().execute(
        ...
        {"section": ZERO_FILL_SECTION, "name": SKILL_NAME, "skill_marker": SKILL_MARKER},
    )
...
def downgrade() -> None:
    op.get_bind().execute(
        ...
        {"section_marker": DAILY_ZERO_FILL_SECTION_MARKER, "name": SKILL_NAME},
    )
