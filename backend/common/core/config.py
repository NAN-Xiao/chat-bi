...
class Settings(BaseSettings):
    ...
    KNOWLEDGE_MANAGEMENT_V2_ENABLED: bool = True
    KNOWLEDGE_RUNTIME_CONTEXT_ENABLED: bool = True
    ...
    KNOWLEDGE_RETRIEVAL_INITIAL_TOP_K: int = 20
    KNOWLEDGE_RETRIEVAL_MAX_CONTEXT_CHARS: int = 12000
    KNOWLEDGE_RETRIEVAL_VECTOR_MIN_SCORE: float = 0.40
    KNOWLEDGE_RETRIEVAL_MIN_SCORE: float = 0.70
    KNOWLEDGE_RETRIEVAL_RERANK_ENABLED: bool = True
    KNOWLEDGE_RETRIEVAL_RERANK_MODEL: str = "BAAI/bge-reranker-v2-m3"
    KNOWLEDGE_RETRIEVAL_RERANK_API_BASE_URL: str | None = None
    KNOWLEDGE_RETRIEVAL_RERANK_API_KEY: str | None = None
    KNOWLEDGE_RETRIEVAL_RERANK_REQUEST_TIMEOUT: int = 30
    KNOWLEDGE_CHUNK_SIZE: int = 1200
    KNOWLEDGE_CHUNK_OVERLAP: int = 150
    KNOWLEDGE_FILE_MAX_BYTES: int = 50 * 1024 * 1024
    KNOWLEDGE_DOCX_MAX_COMPRESSION_RATIO: int = 100
    ...
    @field_validator('SQL_DEBUG',
                     ...
                     'KNOWLEDGE_RETRIEVAL_RERANK_ENABLED',
                     mode='before')
    @classmethod
