...
function editor({ realPreview = false, pivot = false, mixed = false } = {}) {
  ...
  const context = vm.createContext({
    ...
    sourcePreviewPivotPayload: () => undefined, previewPivotPayload: () => pivot ? { enabled: true } : undefined,
    rememberPreviewPivotConfig: () => {}, dashboardDateFilterRequestPayload: () => undefined,
