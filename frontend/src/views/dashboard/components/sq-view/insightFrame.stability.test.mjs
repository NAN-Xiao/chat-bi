...
const boundaryCases = [
  {
    ...
    cases: [
      ['enter', { width: 419, height: 500, previousLayout: 'top', previousDensity: 'compact' }, { show: false, layout: 'top', density: 'basic' }],
      ['enter-boundary', { width: 420, height: 500, previousLayout: 'top', previousDensity: 'compact' }, { show: false, layout: 'top', density: 'basic' }],
      ['enter-after', { width: 421, height: 500, previousLayout: 'top', previousDensity: 'compact' }, { show: false, layout: 'top', density: 'basic' }],
  ...
  },
  {
    ...
    cases: [
      ['enter', { width: 600, height: 339, previousLayout: 'top', previousDensity: 'compact' }, { show: false, layout: 'top', density: 'basic' }],
      ['enter-boundary', { width: 600, height: 340, previousLayout: 'top', previousDensity: 'compact' }, { show: false, layout: 'top', density: 'basic' }],
      ['enter-after', { width: 600, height: 341, previousLayout: 'top', previousDensity: 'compact' }, { show: false, layout: 'top', density: 'basic' }],
