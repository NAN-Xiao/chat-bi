...
import { formatStaticAssetUrl } from '@/utils/url'
...
const init = ref({
  ...
  language_url: formatStaticAssetUrl('./tinymce-custom/langs/zh_CN.js'), // 汉化路径是自定义的，一般放在public或static里面
  language: 'zh_CN',
  skin_url: formatStaticAssetUrl('./tinymce-custom/skins/ui/oxide'), // 皮肤
  content_css: formatStaticAssetUrl('./tinymce-custom/skins/content/default/content.css'),
  plugins:
