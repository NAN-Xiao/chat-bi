...
- `backend/.venv/Scripts/python.exe -m pytest backend/tests`: not run because `backend/.venv` does not exist.
- `backend/.venv/Scripts/python.exe -m ruff check backend`: not run because `backend/.venv` does not exist.
- `backend/.venv/Scripts/python.exe -m mypy backend`: not run because `backend/.venv` does not exist.
